...
import { Mail, Globe, Heart, Shield, Zap, Target, ArrowRight, Sparkles } from "lucide-react"
      ...
      <main className="relative pt-40 pb-32">
        ...
        <div className="container mx-auto px-6">
          ...
          <section className="max-w-4xl mx-auto text-center mb-40">
            ...
            <FadeIn delay={0.1}>
              <h1 className="text-6xl md:text-8xl font-bold tracking-tighter mb-12 leading-[0.95] text-gradient">
                Automating the <br />
